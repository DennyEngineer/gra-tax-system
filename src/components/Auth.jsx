...
function Auth() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      <div className="md:w-1/2 p-8 flex flex-col justify-center bg-green-800">
        <div className="max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-green-700 p-4 rounded-lg shadow-md">
              ...
              <p className="text-gray-200 text-sm">Bank-level encryption and full regulatory compliance.</p>
            </div>
            ...
            <div className="bg-green-700 p-4 rounded-lg shadow-md">
              ...
              <p className="text-gray-200 text-sm">Streamlined process with intelligent form completion.</p>
            </div>
            ...
            <div className="bg-green-700 p-4 rounded-lg shadow-md">
              ...
              <p className="text-gray-200 text-sm">Access tax information anytime, anywhere.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="md:w-1/2 p-8 flex items-center justify-center">
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8 border border-gray-200">
          ...
          {error && (
            <div className="mb-6 p-3 bg-red-100 border border-red-400 text-red-700 rounded-lg text-sm flex items-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-green-700 hover:bg-green-800 text-white font-semibold rounded-lg shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 flex items-center justify-center"
            >
              {isLoading ? (
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3 w-full">
              <button
                type="button"
                className="w-full py-2 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 flex items-center justify-center text-gray-700 shadow-sm transition-colors"
              >
